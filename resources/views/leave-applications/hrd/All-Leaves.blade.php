        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center mb-6">
                <div class="text-white">
                    ...
                    <p class="text-blue-100 text-lg opacity-90 mt-2">Kelola semua pengajuan cuti karyawan perusahaan</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 pb-12 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-lg border-b-4 border-green-500 p-6 mb-6">
                ...
                <div class="text-2xl font-bold text-green-700">{{ $approvedCount ?? 0 }}</div>
                <div class="text-sm font-semibold text-green-600 mt-1">Disetujui</div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border-b-4 border-blue-500 p-6 mb-6">
            <div class="flex justify-between items-start mb-6">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Saring data pengajuan cuti berdasarkan kriteria tertentu</p>
                </div>
            </div>

            <form method="GET" action="{{ route('hrd.all-leaves') }}" class="space-y-4 pt-4 border-t border-gray-100">
                
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Status</label>
                        <select name="status" 
                                class="w-full border border-gray-300 rounded-lg text-sm focus:ring-blue-500 focus:border-blue-500 py-2.5 px-3 bg-white">
                            ...
                            <option value="rejected_by_leader" {{ request('status') == 'rejected_by_leader' ? 'selected' : '' }}>Ditolak Atasan</option>
                ...
                <div class="flex gap-3 justify-end pt-2">
                    <button type="submit" 
                            class="inline-flex items-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('hrd.all-leaves') }}" 
                       class="inline-flex items-center px-5 py-2.5 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-bold text-gray-900">Daftar Semua Pengajuan Cuti</h3>
            <a href="{{ route('dashboard') }}" 
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-xs text-gray-400">
                                                {{ $application->applicant->role ?? 'N/A' }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                        $statusConfig = [
                                            ...
                                            'approved_by_leader' => ['color' => 'bg-blue-100 text-blue-800 border border-blue-200', 'icon' => '✅', 'text' => 'Disetujui Atasan'],
                                            'approved_by_hrd' => ['color' => 'bg-green-100 text-green-800 border border-green-200', 'icon' => '🎉', 'text' => 'Disetujui HRD'],
                                            'rejected_by_leader' => ['color' => 'bg-red-100 text-red-800 border border-red-200', 'icon' => '❌', 'text' => 'Ditolak Atasan'],
